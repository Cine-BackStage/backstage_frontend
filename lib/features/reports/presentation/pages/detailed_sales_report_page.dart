              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Expanded(
                      child: _buildGroupByChip('cashier', 'Operador'),
                    ),
                    const SizedBox(width: 8),
                    Expanded(
                      child: _buildGroupByChip('payment_method', 'Pagamento'),
                    ),
                  ],
                ),
              ],
                        ...
                        children: [
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  _buildSummaryRow(
                                    'Descontos',
                                    currencyFormat.format(report.summary.totalDiscount),
                                    context,
                                  ),
                                  _buildSummaryRow(
                                    'Ticket Médio',
                                    currencyFormat.format(report.summary.averageSaleValue),
                                    context,
                                  ),
                                ],
                              ),
                          ...
                          ...report.groupedData.map((data) => Card(
                                ...
                                child: ListTile(
                                  ...
                                  subtitle: Text('${data.salesCount} vendas'),
                                  trailing: Text(
